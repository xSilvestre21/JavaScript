/*
    ...
    Quando tentamos acessar um membro de um objeto, primeiro o motor do JS vai tentar encontrar este membro
...
const pessoa1 = new Pessoa('Gustavo', 'Silvestre'); // <- Pessoa = Função construtora
const pessoa2 = new Pessoa('Maria', 'Almeida'); // <- Pessoa = Função construtora
